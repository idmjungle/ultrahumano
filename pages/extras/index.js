...
export async function getStaticProps() {
    const pres = await fetch(`https://data.ultrahumano.com/wordpress/wp-json/wp/v2/posts?categories=6&per_page=16&_fields=id,excerpt,title,slug,acf,categories,x_categories,x_featured_media_large`)
