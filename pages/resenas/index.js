...
export async function getServerSideProps({query: {page = 1}}) {
    ...
    const pres = await fetch(`${API_URL}/wp-json/wp/v2/posts?categories=4&per_page=${PER_PAGE}&offset=${start}&_fields=id,excerpt,title,slug,acf,categories,x_categories,x_featured_media_large`)
